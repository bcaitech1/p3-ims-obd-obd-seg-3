...
if __name__ == '__main__':
    ...
    ### scheduler는 비활성화 해둠
    parser.add_argument('--swa_lr', type=float, default=5e-5, help='learning rate (default: 5e-5)')
    parser.add_argument('--swa_start_epoch', type=int, default=99999 , help='number of epochs to start swa (default: 15)')
...
###### step2 : 각자 aistages 서버탭에 있는 tensorboard 주소로 접속
    ...
    args.name = "(NoCutmix_OnAugmentation)DeepLapV3PlusEfficientnetB0NoisyStudent"
    args.cutmix = False
    # args.copyblob = True
    ...
    args.model = 'DeepLapV3PlusEfficientnetB0NoisyStudent'
    args.name = "(only_swa)DeepLapV3PlusEfficientnetB0NoisyStudent"
    args.cutmix = True
    args.swa_start_epoch = 16
    # args.copyblob = True
    # args.load_model = True
    train(data_dir, model_dir, args)
